...
def setimages():
    ...
    v.keyboard_light = tkinter.PhotoImage(
        master=v.root, file="./assets/keyboard_light.png"
    )
    v.keyboard_dark = tkinter.PhotoImage(
        master=v.root, file="./assets/keyboard_dark.png"
    )
